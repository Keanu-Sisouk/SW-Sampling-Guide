...
# for d in dim_list:
    ...
    for p in range(100):
        ...
        for i in range(len(N_list)):
            ...
            # print(SW)
            SW, total = SW_RQMC(X,Y,L=N_list[i], seq="sobol")
        ...
        np.save("new_timers_sobolrand_leluc_in_"+str(d)+"D.npy", np.array(timers_list))
    ...
    np.save("errors_sobolrand_leluc_in_"+str(d)+"D.npy", np.array(mean_error_list))
