...
class SamplerAgent:
    ...
    def Riesz_noblur_gradient(self,n, budget,order,step_size):
        shape = (1,self.dim)
    ...
    def gen_sobol(self,N, sobol_list):
        ...
        sobol_points = self.sobol_sampler.random(N-lenlist)
    ...
    def gen_sobol_rand(self,N, rand_sobol_list):
        ...
        rand_sobol_points = self.sobol_sampler_rand.random(N-lenlist)
