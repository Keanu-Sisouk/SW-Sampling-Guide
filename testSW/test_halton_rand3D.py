...
for p in range(100):
    ...
    np.save("timers_haltonarearand_SWIncluded_in_"+str(d)+"D.npy", np.array(timers_list))
...
np.save("errors_haltonarearand_SWIncluded_in_"+str(d)+"D.npy", np.array(mean_error_list))
