...
# for d in dim_list:
    ...
    for p in range(100):
        ...
        for i in range(len(N_list)):
            ...
            # t1 = time.time()
            # total = t1 - t0
            # new_points = np.load("first_"+str(N_list[i])+"_ortho_points_in_"+str(d)+"D_version_"+str(p)+".npy")
        ...
        np.save("timers_ortho_SWIncluded_PointsStored_in_"+str(d)+"D.npy", np.array(timers_list))
        # print(p)
